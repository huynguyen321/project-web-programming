...
<div class="container-fluid d-flex flex-row mb-3">
    <div class="nav flex-column nav-pills col-2" id="v-pills-tab" role="tablist" aria-orientation="vertical">
        ...
        <a class="nav-link" id="v-pills-smartphone-tab" data-toggle="pill" href="#v-pills-smartphone" role="tab" aria-controls="v-pills-smartphone" aria-selected="false">Smartphone</a>
        <a class="nav-link" id="v-pills-accessories-tab" data-toggle="pill" href="#v-pills-accessories" role="tab" aria-controls="v-pills-accessories" aria-selected="false">Accessories</a>
