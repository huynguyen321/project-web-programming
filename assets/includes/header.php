...
<body>
    <header class="container-fluid">
        ...
        <ul class="main_header">
            ...
            <li>
                <button class="btn btn-info hide_res"><i class="fa fa-shopping-cart" aria-hidden="true"></i>Giỏ hàng</button>
            </li>
            <li>
                <button class="btn btn-info hide_res"><i class="fa fa-sign-in-alt" aria-hidden="true"></i>Đăng nhập</button>
            </li>
            <li>
                <button class="btn btn-info hide_res"><i class="fa fa-user-plus" aria-hidden="true"></i>Đăng ký</button>
            </li>
